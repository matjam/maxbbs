...
func (uu *UserUpdate) SetNillableUpdated(t *time.Time) *UserUpdate {
	if t != nil {
		uu.SetUpdated(*t)
	}
	return uu
...
func (uu *UserUpdate) SetOptions(so *schema.UserOptions) *UserUpdate {
	uu.mutation.SetOptions(so)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Options(); ok {
...
// SetNillableUpdated sets the "updated" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableUpdated(t *time.Time) *UserUpdateOne {
	if t != nil {
		uuo.SetUpdated(*t)
	}
	return uuo
...
// SetOptions sets the "options" field.
func (uuo *UserUpdateOne) SetOptions(so *schema.UserOptions) *UserUpdateOne {
	uuo.mutation.SetOptions(so)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Options(); ok {
		_spec.SetField(user.FieldOptions, field.TypeJSON, value)
	}
